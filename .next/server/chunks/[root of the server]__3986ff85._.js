...
"[project]/.next-internal/server/app/api/accounts/delete/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/api/accounts/delete/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
/* __next_internal_action_entry_do_not_use__ {"4086cb8b96bfe1f2c44bc176a140561ecbfa22b96e":"DELETE"} */ __turbopack_context__.s({
    "DELETE": (()=>DELETE)
});
...
;
;
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ DELETE(req) {
    try {
        ...
        if (!account) {
            console.error(`Account ${accountId} not found or doesn't belong to user ${userId}`);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        // Delete account
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].account.delete({
            where: {
                id: accountId
            }
        });
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(DELETE, "4086cb8b96bfe1f2c44bc176a140561ecbfa22b96e", null);
}}),

};

//# sourceMappingURL=%5Broot%20of%20the%20server%5D__3986ff85._.js.map