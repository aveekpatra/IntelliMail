...
"[project]/.next-internal/server/app/api/accounts/gmail/status/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/api/accounts/gmail/status/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
/* __next_internal_action_entry_do_not_use__ {"0096d677715671639ba5a3744ae1f6b0b4ecaadaaa":"GET"} */ __turbopack_context__.s({
    "GET": (()=>GET)
});
...
;
;
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ GET() {
    try {
        ...
        const gmailAccounts = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].account.findMany({
            where: {
                userId: userId,
                provider: "Gmail"
            },
        ...
        console.log(`[GMAIL STATUS] Found ${gmailAccounts.length} Gmail accounts for user ${userId}:`, accountsWithTimestamp.map((acc)=>({
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(GET, "0096d677715671639ba5a3744ae1f6b0b4ecaadaaa", null);
}}),

};

//# sourceMappingURL=%5Broot%20of%20the%20server%5D__fe18c9f0._.js.map