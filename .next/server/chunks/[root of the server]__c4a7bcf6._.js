...
"[project]/.next-internal/server/app/api/gmail/emails/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/api/gmail/emails/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
/* __next_internal_action_entry_do_not_use__ {"406a4b98e8a2ae3c8e1357a5c428bfc92325af80b5":"GET"} */ __turbopack_context__.s({
    "GET": (()=>GET)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/build/webpack/loaders/next-flight-loader/server-reference.js [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$app$2d$render$2f$encryption$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/app-render/encryption.js [app-route] (ecmascript)");
...
;
;
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ GET(req) {
    try {
        // Get query parameters
        const url = new URL(req.url);
        const limit = parseInt(url.searchParams.get("limit") || "20");
        const accountId = url.searchParams.get("accountId");
        console.log(`[GMAIL EMAILS] Fetching emails, limit: ${limit}, accountId: ${accountId}`);
        ...
        let account;
        if (accountId) {
            account = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].account.findUnique({
                where: {
                    id: accountId,
                    userId: userId,
                    provider: "Gmail"
            ...
            account = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$server$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].account.findFirst({
                where: {
                    userId: userId,
                    provider: "Gmail"
                }
        ...
        console.log(`[GMAIL EMAILS] Found account: ${account.emailAddress}, ID: ${account.id}`);
        try {
            ...
            const emails = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gmail$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchGmailEmails"])(account.token, limit, account.refreshToken);
            console.log(`[GMAIL EMAILS] Successfully fetched ${emails.length} emails`);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                emails,
                account: {
                    id: account.id,
            ...
            if (error instanceof Error && (error.message.includes("Invalid Credentials") || error.message.includes("401") || error.message.includes("invalid_grant") || error.message.includes("unauthorized")) && account.refreshToken) {
                console.log("[GMAIL EMAILS] Access token expired, attempting to refresh");
                ...
                try {
                    // Refresh the token
                    const { accessToken } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gmail$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["refreshGmailToken"])(account.refreshToken);
                    ...
                    console.log("[GMAIL EMAILS] Token refreshed successfully, retrying fetch");
                    console.log("New token info:", {
                        tokenLength: accessToken?.length || 0
                    });
                    // Retry with the new token
                    const emails = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$gmail$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchGmailEmails"])(accessToken, limit, account.refreshToken);
                    console.log(`[GMAIL EMAILS] Successfully fetched ${emails.length} emails after token refresh`);
                    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                        emails,
                        account: {
                            id: account.id,
                    ...
                    console.error("[GMAIL EMAILS] Failed to refresh token:", refreshError);
                    console.error("Error details:", refreshError instanceof Error ? refreshError.message : "Unknown error");
                    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                        error: "Failed to refresh Gmail access token",
                        message: "Your Gmail access has expired. Please reconnect your account."
                    }, {
                        status: 401
                    });
                }
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(GET, "406a4b98e8a2ae3c8e1357a5c428bfc92325af80b5", null);
}}),

};

//# sourceMappingURL=%5Broot%20of%20the%20server%5D__c4a7bcf6._.js.map